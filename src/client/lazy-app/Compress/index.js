...
export default class Compress extends Component {
    ...
    render({ onBack }, { loading, sides, source, mobileView, preprocessorState }) {
        ...
        return (_jsxs("div", { class: style.compress, children: [_jsx(Output, { source: source, mobileView: mobileView, leftCompressed: leftImageData, rightCompressed: rightImageData, leftImgContain: leftImgContain, rightImgContain: rightImgContain, preprocessorState: preprocessorState, onPreprocessorChange: this.onPreprocessorChange }), _jsx("button", { class: style.back, onClick: onBack, children: _jsxs("svg", { viewBox: "0 0 61 53.3", children: [_jsx("title", { children: "Back" }), _jsx("path", { class: style.backBlob, d: "M0 25.6c-.5-7.1 4.1-14.5 10-19.1S23.4.1 32.2 0c8.8 0 19 1.6 24.4 8s5.6 17.8 1.7 27a29.7 29.7 0 01-20.5 18c-8.4 1.5-17.3-2.6-24.5-8S.5 32.6.1 25.6z" }), _jsx("path", { class: style.backX, d: "M41.6 17.1l-2-2.1-8.3 8.2-8.2-8.2-2 2 8.2 8.3-8.3 8.2 2.1 2 8.2-8.1 8.3 8.2 2-2-8.2-8.3z" })] }) }), mobileView ? (_jsx("div", { class: style.options, children: _jsxs("multi-panel", { class: style.multiPanel, "open-one-only": true, children: [_jsx("div", { class: style.options1Theme, children: results[0] }), _jsx("div", { class: style.options1Theme, children: options[0] }), _jsx("div", { class: style.options2Theme, children: results[1] }), _jsx("div", { class: style.options2Theme, children: options[1] })] }) })) : ([
                    _jsxs("div", { class: style.options1, children: [options[0], results[0]] }, "options1"),
                    _jsxs("div", { class: style.options2, children: [options[1], results[1]] }, "options2"),
                ])] }));
    }
}
