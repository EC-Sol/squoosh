...
export declare class Options extends Component<Props, State> {
    ...
    render({}: Props, { effort, quality, progressive, edgePreservingFilter, lossless, slightLoss, autoEdgePreservingFilter, decodingSpeedTier, photonNoiseIso, alternativeLossy, }: State): h.JSX.Element;
}
export {};
